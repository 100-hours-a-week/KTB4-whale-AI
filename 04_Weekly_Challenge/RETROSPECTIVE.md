...
- 강의 시간에 배운 딥러닝 전체 프로세스를 소스 코드 레벨에서 직접 모델링을 하는 과제입니다.
- 프로세스를 기준으로 모델링을 해야 각 모델의 차이점을 비교 분석할 수 있기 때문입니다.
- 개별 한 줄의 코드가 어떻게 동작하는지 강의 내용과 어떻게 대응되는지 살펴봤습니다.
- 가장 작은 형태부터 최근 트랜드까지 순차적으로 방법을 찾아봤습니다.
